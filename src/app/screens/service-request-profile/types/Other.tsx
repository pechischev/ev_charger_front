...
@observer
@autobind
export class Other extends Component<IOtherProps> {
            ...
            <div className="request-container">
                <div className="request-container_column">
                    ...
                    <div className="request-container__content">
                        <ClientDetailsField type={ERequestType.OTHER}/>
                    </div>
                </div>
                <div className="request-container_column">
                    <div className="request-container__title">Request Information</div>
                    <div className="request-container__content">
                        <RequestInfoMainField type={ERequestType.OTHER} api={api} submitting={submitting}/>
                    </div>
                </div>
                <div className="request-container_column"/>
            </div>
